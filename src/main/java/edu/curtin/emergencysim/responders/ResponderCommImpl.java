...
/**
 * Mock implementation of ResponderComm. Be very, very sure you've understood
 * the point of this
 * class before you start designing or coding anything!
 */
public class ResponderCommImpl implements ResponderComm {
    /**
     * Convenience class for storing a fake incoming 'poll' message, and the time at
     * which it is
    ...
    // A regular expression for validating and extracting parts of outgoing ('send')
    // messages.
    ...
    // We'll provide an 'end' message (to shut down the simulation) after this many
    // seconds.
    // private static final long DURATION = 1000;
    private static final long DURATION = 40;

    // We need to keep track of time here, to work out what message to return from
    // poll() at which
    // point.
    private long startTime;

    // These are the responder messages that will be retrieved via the poll()
    // method, at their
    ...
    /**
     * Return any fake incoming messages scheduled to occur, and which have not
     * already been
     * provided.
     */
    @Override
